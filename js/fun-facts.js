...
function initializeFunFact() {
  ...
  const funFacts = [
    ...
    "Samsung > Apple.",
    "I like photographing wildlife, especially bugs, and uploading them to iNaturalist.",
    "A significant portion of my net worth is in Counter Strike skins and cases...",
    "I won my current laptop (a Razer Blade 14) in a giveaway.",
    "I visited China in 2024 and realized how much cooler their EVs are.",
    "My most viewed YouTube video is a clip from an anime and has nearly 500k views.",
    "In high school, my favorite club was Scholastic Bowl.",
    "High school started at 7:20 AM, and I had to wake up at 5:30 AM to catch the bus, which wasn't fun.",
    "My current phone is a Samsung Galaxy S22 Ultra.",
    "Before Samsung, I used random Chinese phones from Xiaomi, Huawei, LeTV, etc.",
    "I was obsessed with rollercoasters as a kid, and still keep up with the latest news.",
    "The tallest rollercoaster I've been on is Superman: Escape from Krypton at Six Flags Magic Mountain (now closed unfortunately).",
    ...
    "I've documented over 600 species on iNaturalist, mostly insects and birds.",
    "I have a dog.",
    "The hardest level I've beaten in Geometry Dash is Windy Landscape.",
    "I did all of my math homework in college on my S22 Ultra using Samsung Notes... I should probably get a tablet.",
    "I have over 1000 notes in Samsung Notes, mainly consisting of math homework.",
  ];
